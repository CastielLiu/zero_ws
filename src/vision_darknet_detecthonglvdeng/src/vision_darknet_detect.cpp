...
void Yolo3DetectorNode::convert_rect_to_image_obj(std::vector< RectClassScore<float> >& in_objects, autoware_msgs::DetectedObjectArray& out_message,std_msgs::Bool& isgo)
{
	isgo.data =true;
...
void Yolo3DetectorNode::Run()
{
    ...
    /////////////////////////////////////
    publisher_isgo_=node_handle_.advertise<std_msgs::Bool>("/traffic_light",1);
	/////////////////////////////////////////////////////////
